                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Total Times Blood Donated</div>
                                        <h3 class = "display-4" style="padding-left:42%"><!-- $ttBloodDonated --> {{$totalDenotions}}</h3>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body">Appointment Pending Status</div>
                                        <h3 class = "display-4" style="padding-left:42%"><!-- $appointmentPending -->{{$appointmentsPending}}        </h3>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body">Appointment Fail Status</div>
                                        <h3 class = "display-4" style="padding-left:42%"><!-- $appointmentFail --> {{$appointmentsFail}}</h3>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
