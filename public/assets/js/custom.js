(function ($) {
  ...
  $(document).ready(function () {
   ...
   // $("#product-icon-AnnualRevenue").click(function(){
    ...
    $("#product-icon-BusinessAddressZipCode").click(function(){
      $('#product-icon-BusinessAddressZipCode').submit();
    });
    $("#product-icon-FirstName").click(function(){
      $('#product-icon-FirstName').submit();
    });
    $("#product-icon-LastName").click(function(){
      $('#product-icon-LastName').submit();
    });
    $("#product-icon-PhoneNumber").click(function(){
      $('#product-icon-PhoneNumber').submit();
    });
