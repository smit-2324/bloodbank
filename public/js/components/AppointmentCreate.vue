                    ...
                    <div class="row">
                        ...
                        <div class="form-inline col-xs-12">
                            ...
                            <div class="form-group col-sm-4">
                                <input type="date" id="start_date" name="start_date"  class="form-control" v-model="newAppointment.start_date">
                            </div>
                            <div class="form-group col-sm-3">
                                <input type="date" id="start_time" name="start_time" class="form-control" v-model="newAppointment.start_time">
                            </div>
                        </div>
                        <div class="form-inline col-xs-12">
                            ...
                            <div class="form-group col-sm-4">
                                <input type="date" id="end_date" name="end_date"  class="form-control" v-model="newAppointment.end_date">
                            </div>
                            <div class="form-group col-sm-3">
                                <input type="date" id="end_time" name="end_time" class="form-control" v-model="newAppointment.end_time">
                            </div>
                        </div>
                        <div class="form-inline col-xs-12">
...
<script>
    ...
    export default {
        ...
        created() {
            console.log('dtyeryrt5yr6yu6u76ui7');
            this.dateFormatsLoaded = axios.get('/settings/date-formats').then((res) => {
                console.log('dtyeryrt5yr6yu6u76ui7 inside');
